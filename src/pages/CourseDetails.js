                ...
                <div className='mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]'>
                   ...
                   <div className='relative block max-h-[30rem] lg:hidden'>
                        <div className='absolute bottom-0 left-0 h-full w-full shadow-[#161D29_0px_-64px_36px_-28px_inset]'>
                         ...
                         <img src={thumbnail} className='aspect-auto w-full' alt={`${courseName} thumbnail`}/>
                   </div>
                ...
                <div className='max-w-[830px] '>
                    ...
                    <div className='mb-12 py-4'>
                        ...
                        <div className=' flex items-center gap-4 py-4'>
                            <img className='h-14 w-14 rounded-full object-cover' src={instructor.image} alt={`${instructor.firstName} ${instructor.lastName}`}/>
