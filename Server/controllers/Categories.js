...
exports.categoryPageDetails = async (req,res) => {
    try {
      ...
      // Continue even if there are no courses for the selected category
      // Just log it but don't return an error
      ...
      // Handle case when there are no other categories with courses
